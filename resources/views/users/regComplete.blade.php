...
<div class="w-96 md:max-w-2xl md:w-full mx-auto bg-gradient-to-r from-white to-slate-50 p-5 my-5 border-2 border-transparent shadow-xl bg-opacity-50 ">
    ...
    <form action="" method="post" enctype="multipart/form-data">
        @csrf
        <div class="md:flex flex-col justify-between w-full md:flex-row">
            {{-- username --}}
        ...
        <div class="mt-8 p-1">
            <p class="text-base text-black">Already have an account? <a href="#" class="text-blue-500">Login</a></p>
        </div>
    </form>
  </div>
@endsection